...
//!
//! `utf8_transcribe_into` is the crate-private reading every legacy-charset
//! door goes through, and what it counts is the whole contract. Everything a
//! caller can observe lives in `tests/charset/codecs.rs`.

use super::utf8_transcribe_into;
