...
impl<'a> From<&'a DataType> for DataTypeRef<'a> {
    ...
    fn from(value: &'a DataType) -> Self {
        ...
        match value {
            ...
            D::Ascii16 => Self::Ascii16 {},
            D::Ascii24 => Self::Ascii24 {},
...
impl TryFrom<DataTypeValue> for DataType {
    ...
    fn try_from(value: DataTypeValue) -> Result<Self> {
        Ok(match value {
            ...
            DataTypeValue::Ascii16 {} => Self::Ascii16,
            DataTypeValue::Ascii24 {} => Self::Ascii24,
...
impl DataType {
    ...
    pub fn into_value(self) -> Scalar {
        ...
        match &self {
            ...
            D::Ascii16 => tag("ascii16"),
            D::Ascii24 => tag("ascii24"),
    ...
    pub fn from_value(value: Scalar) -> Result<Self> {
        ...
        let dtype = match tag.as_str() {
            ...
            "ascii16" => Self::Ascii16,
            "ascii24" => Self::Ascii24,
