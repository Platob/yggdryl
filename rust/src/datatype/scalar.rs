...
impl DataType {
    ...
    pub const fn id(&self) -> DataTypeId {
        match self {
            ...
            Self::Ascii16 => DataTypeId::Ascii16,
            Self::Ascii24 => DataTypeId::Ascii24,
            Self::Ascii32 => DataTypeId::Ascii32,
            Self::Ascii64 => DataTypeId::Ascii64,
            Self::Ascii96 => DataTypeId::Ascii96,
            Self::Ascii128 => DataTypeId::Ascii128,
...
fn dtype_rank(value: &DataType) -> u8 {
    match value {
        ...
        DataType::Ascii64 => 31,
        DataType::Ascii96 => 32,
        DataType::Ascii128 => 33,
        DataType::Country => 34,
        DataType::Currency => 35,
        DataType::Mic => 36,
        DataType::Cfi => 37,
        DataType::Guid => 38,
        DataType::List(_) => 39,
        DataType::ListView(_) => 40,
        DataType::FixedSizeList(..) => 41,
        DataType::LargeList(_) => 42,
        DataType::LargeListView(_) => 43,
        DataType::Struct(_) => 44,
        DataType::Union(..) => 45,
        DataType::Dictionary(_) => 46,
        DataType::Decimal32 { .. } => 47,
        DataType::Decimal64 { .. } => 48,
        DataType::Decimal128 { .. } => 49,
        DataType::Decimal256 { .. } => 50,
        DataType::Map(_) => 51,
        DataType::RunEndEncoded(_) => 52,
        DataType::Variant => 53,
        DataType::Geometry(_) => 54,
        DataType::Geography(_) => 55,
    }
}
