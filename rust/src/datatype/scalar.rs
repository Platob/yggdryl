...
fn dtype_rank(value: &DataType) -> u8 {
    match value {
        ...
        DataType::Ascii32 => 28,
        DataType::Ascii64 => 29,
        DataType::Ascii128 => 30,
        DataType::List(_) => 31,
        DataType::ListView(_) => 32,
        DataType::FixedSizeList(..) => 33,
        DataType::LargeList(_) => 34,
        DataType::LargeListView(_) => 35,
        DataType::Struct(_) => 36,
        DataType::Union(..) => 37,
        DataType::Dictionary(_) => 38,
        DataType::Decimal32 { .. } => 39,
        DataType::Decimal64 { .. } => 40,
        DataType::Decimal128 { .. } => 41,
        DataType::Decimal256 { .. } => 42,
        DataType::Map(_) => 43,
        DataType::RunEndEncoded(_) => 44,
        DataType::Variant => 45,
        DataType::Geometry(_) => 46,
        DataType::Geography(_) => 47,
    }
}
