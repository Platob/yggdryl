...
fn dtype_rank(value: &DataType) -> u8 {
    match value {
        ...
        DataType::List(_) => 34,
        DataType::ListView(_) => 35,
        DataType::FixedSizeList(..) => 36,
        DataType::LargeList(_) => 37,
        DataType::LargeListView(_) => 38,
        DataType::Struct(_) => 39,
        DataType::Union(..) => 40,
        DataType::Dictionary(_) => 41,
        DataType::Decimal32 { .. } => 42,
        DataType::Decimal64 { .. } => 43,
        DataType::Decimal128 { .. } => 44,
        DataType::Decimal256 { .. } => 45,
        DataType::Map(_) => 46,
        DataType::RunEndEncoded(_) => 47,
        DataType::Variant => 48,
        DataType::Geometry(_) => 49,
        DataType::Geography(_) => 50,
    }
}
