...
use crate::FieldSidecar;
use crate::protocol::{self, ProtocolField, ProtocolFieldMut};
...
mod arrow {
    ...
    impl<D: crate::DataTypeValue> crate::FieldOf<D> {
        ...
        pub fn into_arrow_field(self) -> Result<ArrowField> {
            ...
            let dtype = <D as crate::DataTypeValue>::into_dtype(dtype);
    ...
    pub(crate) fn recognized_arrow_extension(
        ...
        match name.as_str() {
            ...
            STRING_EXTENSION_NAME => {
                ...
                if !crate::string::describes_storage(parameters, storage)? {
                    return Ok(None);
                }
            ...
            BYTES_EXTENSION_NAME => {
                ...
                if !crate::bytes::describes_storage(parameters, storage)? {
                    return Ok(None);
                }
