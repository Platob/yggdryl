...
pub use fix::{
    ...
    DEFAULT_PAYLOAD_COLUMN, ERROR_TAG, FixAnomalies, FixAnomaly, FixBranch, FixCode, FixCodeValue,
...
pub use text::xml::{from_xml_scalar, from_xml_scalar_with_field, into_xml_scalar};
