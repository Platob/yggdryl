...
use crate::hashing::txhash::{TxHash, TxHasher};
use crate::hashing::xxhash::Xxh3;
use crate::hashing::xxhash::arrow::{column_digests, row_digests};
    ...
    for algorithm in DigestAlgorithm::ALL {
        ...
        assert_eq!(
            ...
            &ArrowDataType::FixedSizeBinary(
                i32::try_from(crate::hashing::txhash::width(algorithm)).unwrap()
            )
        );
