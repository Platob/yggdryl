...
use crate::hashing::xxhash::{self, Xxh3};
...
fn every_state_becomes_the_dispatcher_it_names() {
    let mut expected = crate::hashing::xxhash::Xxh32::with_seed(9);
    ...
    assert_eq!(
        crate::Digester::from(crate::hashing::xxhash::Xxh64::new()).algorithm(),
        DigestAlgorithm::Xxh64
    );
    assert_eq!(
        crate::Digester::from(crate::hashing::xxhash::Xxh128::new()).algorithm(),
