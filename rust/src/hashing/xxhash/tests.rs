//! The digest halves an integration test cannot reach.
//!
//! `low_64` is the crate-private narrowing every 64-bit digest takes from its
//! 128-bit sibling. Everything a caller can observe lives in
//! `tests/hashing/xxhash.rs`.

use super::{low_64, xxh3, xxh128};
