...
mod limits {
    ...
    impl MaterializationBudget {
        ...
        fn add_bytes_rows(&mut self, rows: usize, parameters: crate::BytesType) -> Result<()> {
            use arrow_schema::DataType as ArrowDataType;

            match crate::bytes::arrow_storage(parameters)? {
        ...
        fn add_string_rows(&mut self, rows: usize, parameters: crate::StringType) -> Result<()> {
