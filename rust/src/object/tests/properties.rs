...
use crate::Url;
use crate::object::client::Client;
use crate::object::{AssumedRole, AzureOptions, Credentials, Encryption, ObjectOptions, Provider};
...
fn an_azure_blob_type_and_tier_are_read_and_a_name_neither_has_is_refused() {
    ...
    .expect("readable properties");
    assert_eq!(options.azure().blob_type(), crate::object::BlobType::Append);
...
fn an_encryption_shape_a_store_does_not_have_is_refused_when_the_client_is_built() {
    ...
    let refused = crate::object::file_with(
        "az://lake/part.bin",
        ObjectOptions::default()
            .with_environment(false)
            .with_azure(crate::object::AzureOptions::default().with_account("trades"))
