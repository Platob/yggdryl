...
fn decode(raw: RawValue, depth: usize, state: &mut DecodeState) -> Result<Scalar> {
    ...
    match raw {
        ...
        RawValue::Int64(value) => Ok(Scalar::from(value)),
        RawValue::UInt64(value) => Ok(Scalar::from(value)),
        RawValue::Int128(value) => Ok(Scalar::from(value)),
        RawValue::UInt128(value) => Ok(Scalar::from(value)),
