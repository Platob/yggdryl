...
impl super::FixMsg {
    ...
    /// licenses.
    ///
    /// The chain, each step merged into the last through [`Cfi::merged`](crate::types::Cfi::merged)
    ...
    /// merge: [`Cfi::merged`](crate::types::Cfi::merged) answers `None` and the step is dropped,
