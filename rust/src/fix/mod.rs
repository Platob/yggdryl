...
pub use crated::{
    ...
    MSGSESSIONID_TAG_NAME, MSGTYPE_TAG_NAME, NOFIXENTRIES_TAG_NAME, PREVUNIX_TAG_NAME,
    PREVUUID_TAG_NAME, RECDUNIX_TAG_NAME, REFRECDUNIX_TAG_NAME, SEDOLCODE_TAG_NAME,
    SEQNUM_TAG_NAME, SNAPUNIX_TAG_NAME, SOURCEURL_TAG_NAME, SRCUUIDS_TAG_NAME, STATE_TAG_NAME,
