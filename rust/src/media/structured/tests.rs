...
use crate::{ArrowScalar, ArrowShape, DataType, Field, IOBase, IOMedia, IOMode, Scalar, Url};
...
fn options_declaring(field: &Field) -> crate::media::RecordOptions {
    use crate::media::IORecordOptions;

    let mut options = crate::media::RecordOptions::for_media_type(&crate::MediaType::new(
        crate::MimeType::ARROW_STREAM,
    ))
