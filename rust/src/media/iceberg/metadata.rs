...
impl TableMetadata {
    ...
    ///
    /// ```
    /// use yggdryl::media::iceberg::{FormatVersion, PartitionSpec, Snapshot, TableMetadata};
    /// use yggdryl::media::iceberg::assign_field_ids;
...
mod strict_metadata_tests {
    ...
    use crate::media::iceberg::{PartitionSpec, Snapshot, SnapshotRef};
