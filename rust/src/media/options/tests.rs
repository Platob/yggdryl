...
fn record_options_have_complete_value_traits_and_stable_hashes() {
    ...
    let text = crate::media::text::TextOptions::new()
...
fn every_concrete_options_type_carries_the_same_commit_cadence() {
    ...
    assert_cadence(crate::media::avro::AvroOptions::new());
    assert_cadence(crate::media::text::TextOptions::new());
    #[cfg(feature = "parquet")]
    assert_cadence(crate::media::parquet::ParquetOptions::new());
...
fn native_batch_writes_stop_at_the_smaller_conversion_or_commit_bound() {
    assert_eq!(crate::media::DEFAULT_RECORD_BATCH_ROW_SIZE, 65_536);
    assert_eq!(
        crate::arrow::rows::DEFAULT_BATCH_ROW_SIZE,
        crate::media::DEFAULT_RECORD_BATCH_ROW_SIZE
    );
