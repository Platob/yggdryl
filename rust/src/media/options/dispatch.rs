...
impl IORecordOptions for RecordOptions {
    ...
    fn dtype(&self) -> Option<&DataType> {
        match self {
            ...
            Self::Xml(options) => options.dtype(),
        }
    }
    ...
    fn set_dtype(&mut self, dtype: Option<DataType>) {
        match self {
            ...
            Self::Xml(options) => options.set_dtype(dtype),
        }
    }
    ...
    fn metadata(&self) -> &Metadata {
        match self {
            ...
            Self::Xml(options) => options.metadata(),
        }
    }
    ...
    fn set_metadata(&mut self, metadata: Metadata) {
        match self {
            ...
            Self::Xml(options) => options.set_metadata(metadata),
        }
    }
    ...
    fn merge_by_names(&self) -> &[String] {
        match self {
            ...
            Self::Xml(options) => options.merge_by_names(),
        }
    }
    ...
    fn set_merge_by_names(&mut self, merge_by_names: Vec<String>) {
        match self {
            ...
            Self::Xml(options) => options.set_merge_by_names(merge_by_names),
        }
    }
    ...
    fn select_by_names(&self) -> &[String] {
        match self {
            ...
            Self::Xml(options) => options.select_by_names(),
        }
    }
    ...
    fn set_select_by_names(&mut self, select_by_names: Vec<String>) {
        match self {
            ...
            Self::Xml(options) => options.set_select_by_names(select_by_names),
        }
    }
    ...
    fn filter_partitions(&self) -> &[(String, String)] {
        match self {
            ...
            Self::Xml(options) => options.filter_partitions(),
        }
    }
    ...
    fn set_filter_partitions(&mut self, filter_partitions: Vec<(String, String)>) {
        match self {
            ...
            Self::Xml(options) => options.set_filter_partitions(filter_partitions),
        }
    }
}
