...
typed_value_alias!(Ascii16Scalar, ascii::Ascii16, "ascii16");
typed_value_alias!(Ascii24Scalar, ascii::Ascii24, "ascii24");
...
static_value_constructor!(ascii::Ascii16, DataType::Ascii16);
static_value_constructor!(ascii::Ascii24, DataType::Ascii24);
