...
fn temporal_markers_cover_clock_calendar_and_interval_types() {
    ...
    assert_typed_marker::<yggdryl::types::Time64Type>(DataType::time64(TimeUnit::Microsecond).unwrap());
    assert_typed_marker::<yggdryl::types::Duration32Type>(DataType::Duration32(TimeUnit::Millisecond));
    assert_typed_marker::<yggdryl::types::Duration64Type>(DataType::Duration64(TimeUnit::Millisecond));
