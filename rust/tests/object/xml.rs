//! `rust/src/object/xml.rs`: the scanner no caller can name.
//!
...
//! this scanner is pinned in `rust/tests/object/aws/xml.rs` and
//! `rust/tests/object/azure/xml.rs`.

use yggdryl::internals::object_answer::ErrorBody;
use yggdryl::internals::object_xml::parse_error;
