//! `rust/src/charset/transcoded.rs`: the handle that decodes on the way in and
//! encodes on the way out, and what a reader downstream of it sees.

mod codecs {

    use yggdryl::charset::{Charset, Transcoded};
    use yggdryl::holder::Buffer;
    use yggdryl::{IOBase, MediaType};
