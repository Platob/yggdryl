//! `rust/src/s3/encryption.rs`: encryption at rest, and what each kind
//! puts on the wire.
//!
...
use yggdryl::s3::{CustomerKey, Encryption, KmsKey, S3Options};
...
fn header(store: &crate::server::FakeS3, index: usize, name: &str) -> Option<String> {
