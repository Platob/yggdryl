//! The instrument's classification: what the value knows, and what a message
//! licenses it to say.
//!
//! The ISO 10962 semantics live beside the [`CfiCode`] value, and FIX's half is
//! only which tags name a category. These are the seams between them.
