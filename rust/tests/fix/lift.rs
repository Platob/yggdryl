...
fn an_order_answers_who_what_how_much_and_when() {
    let reader = reader();
    let order = reader
        .sole_line(b"8=FIX.4.4|35=D|49=SENDER|56=TARGET|34=7|11=ORDER-1|55=AAPL|54=1|38=100|44=12.5|60=20240102-10:15:30.000|10=0|", false)
        .unwrap();
...
fn a_fallback_is_visible_through_the_source_it_resolved_from() {
    ...
    let message = reader
        .sole_line(b"8=FIX.4.4|35=D|11=A|52=20240102-10:15:30.000|10=0|", false)
        .unwrap();
    assert_eq!(
...
fn a_superseded_source_is_tried_after_every_current_one() {
    ...
    let old = reader
        .sole_line(b"8=FIX.4.4|35=D|11=A|38=100|465=1|10=0|", false)
        .unwrap();
    assert_eq!(old.lift_source("quantitytype"), Some(465));

    // Carrying both, the current one wins whichever order they arrived in.
    let both = reader
        .sole_line(b"8=FIX.4.4|35=D|11=A|38=100|465=1|854=2|10=0|", false)
        .unwrap();
...
fn a_quantity_is_answered_with_its_unit_whenever_the_message_states_one() {
    let reader = reader();
    let stated = reader
        .sole_line(b"8=FIX.4.4|35=D|11=A|53=1000000|854=5|15=USD|10=0|", false)
        .unwrap();
    ...
    let bare = reader
        .sole_line(b"8=FIX.4.4|35=D|11=A|53=1000000|10=0|", false)
        .unwrap();
...
fn a_side_and_a_price_fill_their_lane_on_an_order_and_not_on_a_fill() {
    ...
    let sell = reader
        .sole_line(b"8=FIX.4.4|35=D|11=A|54=2|44=12.5|38=100|10=0|", false)
        .unwrap();
    ...
    let cross = reader
        .sole_line(b"8=FIX.4.4|35=D|11=A|54=8|44=12.5|38=100|10=0|", false)
        .unwrap();
...
fn one_lane_implies_a_side_and_two_lanes_imply_nothing() {
    ...
    let both = reader
        .sole_line(b"8=FIX.4.4|35=S|117=Q1|132=12.4|133=12.6|10=0|", false)
        .unwrap();
    assert_eq!(both.lifted("side"), None);

    // An order is not a quote, so no lane implies its side.
    let order = reader
        .sole_line(b"8=FIX.4.4|35=D|11=A|132=12.4|10=0|", false)
        .unwrap();
...
fn anomalies_are_derived_from_the_row_against_the_entries() {
    ...
    let untyped = reader
        .sole_line(b"8=FIX.4.4|35=D|9=abc|11=A|10=0|", false)
        .unwrap();
    ...
    let miscounted = reader
        .sole_line(b"MSGTYPE=D|#NOPARTYIDS=3|#NOPARTYIDS[0]=PARTYID=ONE", false)
        .unwrap();
