...
//! line, refused where the answer is not certain, and settled in one parse.
//! The committed set takes the shipped native plan; an edited or additional
//! rule takes the same terms through the dynamic plan.
