...
fn register_classes(module: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    module.add_class::<market::PyOrder>()?;
    module.add_class::<market::PyExecution>()?;
    module.add_class::<market::PyTrade>()?;
    module.add_class::<market::PyQuote>()?;
    module.add_class::<market::PyBook>()?;
    module.add_class::<market::PyOrders>()?;
    module.add_class::<market::PyExecutions>()?;
    module.add_class::<market::PyTrades>()?;
    module.add_class::<market::PyQuotes>()?;
    module.add_class::<market::PyBooks>()?;
    module.add_class::<market::PyStatements>()?;
    module.add_class::<market::PySymbol>()?;
    module.add_class::<market::PyBookIterator>()?;
