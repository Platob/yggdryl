...
class FixBranch:
    ...
    @staticmethod
    def _from_parts(
        name: str, version: str, sender_comp_id: str, target_comp_id: str
    ) -> FixBranch: ...
    @property
    def name(self) -> str: ...
    @property
...
class FixRegistry:
    ...
    def branch_for_session(self, sender: str, target: str) -> FixBranch | None: ...
...
class FixMsg:
    ...
    def entries(self) -> list[tuple[int, str | None, str, str]]: ...
    def to_row(self, projection: FixProjection) -> Scalar: ...
...
class FixReader:
    ...
    @property
    def registry(self) -> FixRegistry: ...
    def text(self, row: str) -> FixMsg: ...
    # `bytes` is this class's own reader, which shadows the built-in inside the
    # body, so the argument types name it through the module it comes from.
    def bytes(self, row: builtins.bytes | bytearray | memoryview) -> FixMsg: ...
    def fixtext(
        self, body: builtins.bytes | bytearray | memoryview, separator: int = 1
    ) -> FixMsg: ...
    def ultext(self, body: builtins.bytes | bytearray | memoryview) -> FixMsg: ...
    def pairs(self, pairs: Sequence[tuple[str, str]]) -> FixMsg: ...
    def __copy__(self) -> FixReader: ...
    def __deepcopy__(self, memo: Any) -> FixReader: ...
    def __repr__(self) -> str: ...
...
class FixProjection:
    ...
    ``carrier`` is a capture's own root, whose columns lead the row where one is
    given. A column carries the tag it was resolved from, or ``0`` where it
    carries none - the two closing lists, and every carried column.
    """
    ...
    def __init__(
        ...
        registry: FixRegistry | None = None,
        name: str = "fix",
        carrier: FieldLike | None = None,
    ) -> None: ...
    @staticmethod
    def from_field(field: FieldLike) -> FixProjection: ...
    @property
    def field(self) -> Field: ...
    @property
    def tags(self) -> list[int]: ...
    ...
    @property
    def carried_positions(self) -> list[int]: ...
    @property
    def value_columns(self) -> int: ...
    def column(self, at: int) -> Field | None: ...
    def position_of(self, tag: int) -> int | None: ...
    def __len__(self) -> int: ...
    def __repr__(self) -> str: ...
