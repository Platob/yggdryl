...
class DataType:
    ...
    # Three formats, one structural model: `to_dict` is the model every
    ...
    def to_yaml(self, *, indent: int | None = 2) -> str: ...
    def into_yaml(self, *, indent: int | None = 2) -> str: ...
    @staticmethod
    def from_toml(value: str) -> DataType: ...
    def to_toml(self, *, indent: int | None = None) -> str: ...
...
class Namespaces:
    ...
    def values(self) -> list[Namespace]: ...
    def items(self) -> list[tuple[str, Namespace]]: ...
