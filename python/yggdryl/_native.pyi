...
class Serie:
    ...
    # Arrow C exporter, a `Serie` or `SerieReader` - crosses as the column it
    # holds, a stream drained; any other value is read as a `Scalar`, a
    # sequence as its rows and anything else as one row.
    @staticmethod
    def from_(
        value: object,
        field: object | None = None,
