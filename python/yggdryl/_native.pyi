...
class TextLine:
    ...
    @property
    def captures(self) -> tuple[bytes | None, ...]: ...
    @property
    def entries(self) -> TextEntries | None: ...
    def get_entry_by_path(self, path: str | FieldPath) -> TextEntry | None: ...
    def entry_by_path(self, path: str | FieldPath) -> TextEntry: ...
    def set_entry_by_path(self, path: str | FieldPath, value: bytes) -> None: ...
...
class FixBranch:
    ...
    @staticmethod
    def _from_parts(name: str, version: str, aliases: Sequence[str]) -> FixBranch: ...
    @property
    def name(self) -> str: ...
    @property
...
class MsgType:
    ...
    @property
    def field(self) -> Field: ...
    def get_group_by_counter(self, id: str) -> Field | None: ...
    def stable_hash(self) -> int: ...
    def __hash__(self) -> int: ...
    def __eq__(self, other: object, /) -> bool: ...
    def __ne__(self, other: object, /) -> bool: ...
...
class FixRegistry:
    ...
    def get_definition(self, category: str, name: str, branch: str | None = None) -> Field | None: ...
    def definition(self, category: str, name: str, branch: str | None = None) -> Field: ...
    ...
    def remove_definition(self, category: str, name: str, branch: str | None = None) -> Field | None: ...
    def get_msgtype(self, spelling: str, branch: str | None = None) -> MsgType | None: ...
    def msgtype(self, spelling: str, branch: str | None = None) -> MsgType: ...
    def msgtypes(self) -> MsgTypeIterator: ...
    def get_group_by_counter(self, id: str) -> Field | None: ...
    def group_by_counter(self, id: str) -> Field: ...
    def into_json(self) -> str: ...
    def stable_hash(self) -> int: ...
    ...
    def get_field_by_path(
        self, path: str | FieldPath, branch: str | None = None
    ) -> Field | None: ...
    def field_by_path(self, path: str | FieldPath, branch: str | None = None) -> Field: ...
...
class FixCodec:
    ...
    branch and a version cross as ``str`` and are parsed once at the boundary.
    """
