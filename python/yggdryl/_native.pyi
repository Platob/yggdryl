...
class FixCodec:
    ...
    @property
    def registry(self) -> FixRegistry: ...
    def read_line(self, row: bytes | bytearray | memoryview) -> FixMsg: ...
    def read_fix_line(
        self, body: bytes | bytearray | memoryview, separator: int | None = None
    ) -> FixMsg: ...
    def read_ullink_line(self, body: bytes | bytearray | memoryview) -> FixMsg: ...
    def read_fixml_line(self, body: bytes | bytearray | memoryview) -> FixMsg: ...
    def read_pairs(self, pairs: Sequence[tuple[str, str]]) -> FixMsg: ...
