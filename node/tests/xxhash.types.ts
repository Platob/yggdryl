...
import { Digest, IOBase, Scalar, Xxh3_64, Xxh3_128, Xxh32, Xxh64, enums, xxhash } from 'yggdryl'
...
const fast: bigint = xxhash.xxh3_64(payload)
const widest: bigint = xxhash.xxh3_128(payload)
void narrow
void wide
void fast
void widest
...
xxhash.xxh3_64(new Uint8Array(payload))
xxhash.xxh3_64(payload.buffer)
xxhash.xxh3_64('AAPL,187.23')

// Seeds and secrets.
xxhash.xxh32(payload, { seed: 42 })
xxhash.xxh64(payload, { seed: 42n })
xxhash.xxh3_64(payload, { seed: 42n, secret: new Uint8Array(xxhash.SECRET_MINIMUM_LENGTH) })
xxhash.xxh3_128(payload, 42n)
...
const state3_64: Xxh3_64 = new Xxh3_64(42n, new Uint8Array(xxhash.SECRET_MINIMUM_LENGTH))
const state3_128: Xxh3_128 = new Xxh3_128()
...
const copied: Xxh3_64 = state3_64.clone()
state32.clear()
void streamed
void seed32
void seed64
