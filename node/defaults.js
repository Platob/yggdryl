...
// only JavaScript identity/caching policy; it never switches on the datatype
// kind to rebuild core schema behavior. A default as Apache Arrow JS is
// `Serie.fromDefault(field).intoArrowScalar()`.
