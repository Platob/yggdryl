...
const optional = new data.OptionalInt64Scalar(42n)
const encoded = int64.nativeToBytes(42n)

bench('new Int64Scalar(42n)', () => new data.Int64Scalar(42n))
...
bench('new OptionalInt64Scalar(42n)', () => new data.OptionalInt64Scalar(42n))
