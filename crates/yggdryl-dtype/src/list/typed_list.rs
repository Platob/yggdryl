...
///
/// The concrete value type is [`List`](super::List)'s associated
/// [`ValueType`](super::List::ValueType), here refined to a
/// [`TypedDataType<T>`]; `value_type` is inherited from [`List`](super::List) and
...
/// ```
pub trait TypedList<T>: List<ValueType: TypedDataType<T>> + TypedDataType<Vec<T>> {}
