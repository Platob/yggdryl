...
/// The generic [`SerieType<D>`](crate::SerieType) and [`MapType<K, V>`](crate::MapType)
...
///
/// ```
/// use yggdryl_dtype::{Int64Type, SerieType, MapType, TypedDataType, TypedNested, UInt8Type};
///
/// fn children_of<T, N: TypedNested<T>>(nested: &N) -> usize {
///     nested.child_count()
/// }
///
/// assert_eq!(children_of::<Vec<i64>, _>(&SerieType::new(Int64Type)), 1);
