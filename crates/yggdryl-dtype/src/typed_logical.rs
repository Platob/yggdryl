...
/// its physical storage. The generic [`OptionalType<D>`](crate::OptionalType) is the
/// crate's generic holder: a `TypedLogical<T>` over
/// [`UnionType`](crate::UnionType) storage for any value type `D: TypedDataType<T>`.
///
/// ```
/// use yggdryl_dtype::{DataType, Int64Type, Logical, OptionalType, TypedLogical};
///
