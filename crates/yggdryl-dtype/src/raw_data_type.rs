...
/// Concrete types ([`Int32`](crate::Int32), `Utf8`, `Boolean`, …) implement it, and
/// the parameterised `RawField` (in `yggdryl-field`) and `RawScalar` (in
/// `yggdryl-scalar`) build on it.
///
...
///
/// ```
/// use yggdryl_dtype::{arrow_schema, DataError, RawDataType};
///
