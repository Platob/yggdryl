...
let uri = Uri::from_str("https://example.com/a%20b?p=2#intro").unwrap();
assert_eq!(uri.scheme(), "https");

let url = Url::from_str("https://user:pw@example.com:8443/api?a=1&a=2").unwrap();
...
assert_eq!(Uri::from_str("git+ssh://h/r").unwrap().scheme_base(), "git");
