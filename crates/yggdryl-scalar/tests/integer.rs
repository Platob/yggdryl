...
use yggdryl_scalar::yggdryl_dtype::{self as dtype, DataError, RawDataType};
use yggdryl_scalar::{
    arrow_array, arrow_schema, Int16, Int32, Int64, Int8, RawScalar, Scalar, UInt16, UInt32,
    UInt64, UInt8,
};
...
macro_rules! integer_scalar_tests {
    ($mod:ident, $ty:ident, $native:ty, $as_native:ident, $array:ident, $name:literal) => {
        mod $mod {
            use super::*;
...
integer_scalar_tests!(int8, Int8, i8, as_i8, Int8Array, "int8");
integer_scalar_tests!(int16, Int16, i16, as_i16, Int16Array, "int16");
integer_scalar_tests!(int32, Int32, i32, as_i32, Int32Array, "int32");
integer_scalar_tests!(int64, Int64, i64, as_i64, Int64Array, "int64");
integer_scalar_tests!(uint8, UInt8, u8, as_u8, UInt8Array, "uint8");
integer_scalar_tests!(uint16, UInt16, u16, as_u16, UInt16Array, "uint16");
integer_scalar_tests!(uint32, UInt32, u32, as_u32, UInt32Array, "uint32");
integer_scalar_tests!(uint64, UInt64, u64, as_u64, UInt64Array, "uint64");

// Cross-checked against arrow-schema: the scalar's data type mirrors the variant.
#[test]
fn scalar_data_types_match_arrow() {
    assert_eq!(
        Int64::new(1).data_type().to_arrow(),
        arrow_schema::DataType::Int64
    );
    assert_eq!(
        UInt8::new(1).data_type().to_arrow(),
