//! The `serie` scalars: the generic [`Serie`] and the buffer-backed [`Int64Serie`].
//!
...
//! zero-copy Arrow child array with per-element scalar accessors; [`Int64Serie`] is
//! the concrete serie of `int64`, borrowing the raw Arrow buffers for native `i64`
//! access. The matching [`SerieType`](yggdryl_dtype::SerieType) data type lives in
