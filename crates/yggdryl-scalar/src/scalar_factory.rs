...
///
/// ```
/// use yggdryl_scalar::yggdryl_dtype::{Int64Type, TypedSerieType, TypedOptionalType};
...
/// assert!(!TypedSerieType::new(Int64Type).default_scalar().is_null());
/// assert!(TypedOptionalType::new(Int64Type).default_scalar().is_null());
///
