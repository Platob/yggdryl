//! The [`RawScalar`] base trait: a single, possibly-null value of a
...
///
/// ```
/// use yggdryl_scalar::yggdryl_dtype::{DataError, Int32 as Int32Type, RawDataType};
/// use yggdryl_scalar::{arrow_array, RawScalar};
