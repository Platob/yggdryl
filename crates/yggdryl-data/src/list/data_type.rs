...
impl<D: RawDataType> ListType<D> {
    ...
    /// type.
    pub(crate) fn item_field(&self) -> arrow_schema::FieldRef {
...
impl<D: RawDataType> super::RawList<D> for ListType<D> {
    fn value_type(&self) -> &D {
        &self.value_type
    }
}

impl<D: RawDataType> RawDataType for ListType<D> {
    fn name(&self) -> &str {
        "list"
    }
...
impl<T, D: DataType<T>> DataType<Vec<T>> for ListType<D>
where
    D: Default,
