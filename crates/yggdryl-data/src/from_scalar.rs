...
use crate::{DataError, RawDataType, RawScalar};
...
///
/// ```
/// use yggdryl_data::{FromScalar, Int64, RawScalar};
///
...
pub trait FromScalar: Sized {
    ...
    fn from_scalar<D: RawDataType, S: RawScalar<D>>(scalar: &S) -> Result<Self, DataError>;
}
