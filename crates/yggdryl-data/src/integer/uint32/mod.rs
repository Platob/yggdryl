//! The `uint32` integer type: [`UInt32Type`], its nullable field [`UInt32Field`] and scalar
//! [`UInt32`].
//!
//! [`UInt32Type`] is Apache Arrow's `UInt32Type` — a fixed-width
...
//!
//! ```
//! use yggdryl_data::{DataType, UInt32Type, UInt32Field, UInt32, RawDataType, RawField, RawScalar};
//!
...
pub use data_type::UInt32Type;
pub use field::UInt32Field;
pub use scalar::UInt32;
