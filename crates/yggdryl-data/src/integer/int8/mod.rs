//! The `int8` integer type: [`Int8Type`], its nullable field [`Int8Field`] and scalar
//! [`Int8`].
//!
//! [`Int8Type`] is Apache Arrow's `Int8Type` — a fixed-width [`Primitive`](crate::Primitive)
//! whose native Rust type is `i8`, stored little-endian in one byte, Arrow C Data
//! Interface format `"c"`.
//!
//! ```
//! use yggdryl_data::{DataType, Int8Type, Int8Field, Int8, RawDataType, RawField, RawScalar};
//!
