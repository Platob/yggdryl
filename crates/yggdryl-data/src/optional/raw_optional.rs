...
/// the sparse two-variant union between [`NullType`](crate::NullType) and the value type —
...
/// with a codec also gets the typed [`TypedOptional`](crate::TypedOptional) layer.
///
/// ```
/// use yggdryl_data::{Int64Type, OptionalType, RawDataType, RawLogical, RawOptional};
///
