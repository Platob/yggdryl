...
use crate::{
    ByteBuffer, ByteCursor, CompressionDecoder, CompressionEncoder, DecodeError, EncodeError,
    IOBase, IoError, Whence,
};
...
///
/// ```
/// use yggdryl_core::{ByteBuffer, CompressIO, Gzip, IOBase, Whence};
///
