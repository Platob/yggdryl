...
/// The origin a seek offset is measured from — the start, the current cursor, or
/// the end of an [`Io`](crate::Io) source (mirroring POSIX `SEEK_SET` / `SEEK_CUR`
/// / `SEEK_END`).
///
/// ```
...
// free of the `derive` feature, matching `Buffer`.
#[cfg(feature = "serde")]
