...
fn zstd_round_trips_and_streams() {
    use yggdryl_core::{ByteBuffer, IOBase, Whence, Zstd};
...
fn compress_io_round_trips_with_both_codecs() {
    use yggdryl_core::{ByteBuffer, CompressIO, IOBase, Whence, Zstd};
...
fn compress_io_edge_cases() {
    use yggdryl_core::{ByteBuffer, CompressIO, DecodeError, IOBase, Whence};
