//! Deterministic allocation budgets for the in-heap [`Heap`](yggdryl_core::memory::Heap) source —
...
//! [`pread_into`](yggdryl_core::memory::IOBase::pread_into) transfer, and the capacity discipline
