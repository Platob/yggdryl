...
const CORE_PAGES = [
  ...
  { module: 'parquet', title: 'Apache Parquet', bindings: true,
    read: 'rust/src/parquet/ (mod.rs, metadata.rs, geospatial.rs, tests.rs), rust/src/io/media.rs, python/src/io.rs, python/tests/media/test_init.py, node/src/io.rs, node/tests/iobase.test.js',
  ...
  { module: 'json', title: 'JSON', bindings: true,
    read: 'rust/src/json/, rust/tests/json.rs, python/yggdryl/json/, node/tests/text/codec.test.js',
  ...
  { module: 'yaml', title: 'YAML', bindings: true,
    read: 'rust/src/yaml/, rust/tests/yaml.rs, python/yggdryl/yaml/, node/tests/text/codec.test.js',
  ...
  { module: 'toml', title: 'TOML', bindings: true,
    read: 'rust/src/toml/, rust/tests/toml.rs, python/yggdryl/toml/, node/tests/text/codec.test.js',
