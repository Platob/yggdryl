...
def dtype_document(name: str) -> dict[str, Any]:
    ...
    documents: dict[str, dict[str, Any]] = {
        ...
        "Amt": {"type": "float64"},
        "UTCTimestamp": {"type": "datetime64", "unit": "microsecond", "timezone": "UTC"},
        "TZTimestamp": {"type": "datetime64", "unit": "microsecond", "timezone": "UTC"},
        ...
        "LocalMktDatetime": {"type": "datetime64", "unit": "microsecond", "timezone": "UTC"},
