...
| Report | Measures |
| --- | --- |
| [yggdryl-buffer/io/byte_buffer.md](yggdryl-buffer/io/byte_buffer.md) | `ByteBuffer` positioned byte IO + resource transfer |
...
```bash
cargo bench -p yggdryl-buffer -p yggdryl-core          # Rust (io + buffers, then compression/converter)
