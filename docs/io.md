...
store, an Arrow filesystem - implements the same trait outside the core. Two wrapping handles sit
over any of them and are handles themselves: `Coded` below, and the page cache in
[buffered.md](buffered.md).
