...
shipped unexecuted:
[Rust](../notebooks/core_arrow-rust.ipynb){ download },
[Python](../notebooks/core_arrow-python.ipynb){ download },
[JavaScript](../notebooks/core_arrow-javascript.ipynb){ download }.
