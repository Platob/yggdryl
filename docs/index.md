...
| Text | JSON, YAML, TOML, and XML over the shared `Scalar` | [text](text/index.md) |
...
| TxHash | An instant coupled with a digest: sortable keys, coupled columns, and the `digest:time` holder | [txhash](txhash/index.md) |
