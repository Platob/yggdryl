...
- The canonical default of `boolean` is `false`, which is what a cast under the `default` [nullability](../cast.md#strict-nullability) writes where a required column holds a null; `strict` refuses it.
