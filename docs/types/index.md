...
| Families | [Numeric](numeric.md) | Boolean, integer, floating, decimal, and the `Decimal` value |
...
| Families | [Strings & bytes](text.md) | The string family (eighteen leaves: six shapes in each of UTF-8, US-ASCII and windows-1252), the byte family (six leaves), `Str` and `Bytes`, the version and URL values, regex-capture schema inference |
