...
| [Codes](codes/index.md) | [Ccy](codes/ccy.md), [Country](codes/country.md), [MIC](codes/mic.md), [CFI](codes/cfi.md), [ISIN](codes/isin.md), [CUSIP](codes/cusip.md), [SEDOL](codes/sedol.md), [Bbg](codes/bbg.md), [FIGI](codes/figi.md), [RIC](codes/ric.md), [Side](codes/side.md), [State](codes/state.md), [TimeInForce](codes/timeinforce.md), [Unit](codes/unit.md) | Fourteen identities over a published registry: `DataType::CODES`, the `CodeValue` contract, US-ASCII storage with its own Arrow extension name, `StringEnum` vocabularies and the check digits |
