...
=== "Python"
    ...
    ```bash
    python/.venv/bin/python -m pytest python/tests/test_datatype.py python/tests/test__defaults.py -k "list or nested"
...
=== "JavaScript"
    ...
    ```bash
    node --test --test-name-pattern="list|nested" node/tests/fields.test.js node/tests/defaults.test.js
