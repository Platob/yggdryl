...
| `curruuid` | `CurrUuid` | 65039 | the message's identity, a `uuid`: the UUIDv7 its microsecond `currunix`, graph `seqnum`, and `currhashcode` rehashed under `crosshashcode` as seed derive; non-null |
