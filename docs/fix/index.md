...
| [Lifecycle](lifecycle.md) | `FixCodec::lifecycle` and the [graph](../graph/index.md)'s one walk: chains named by the cross code, their creation and history, twins folded, and grid snapshots across a stream |
