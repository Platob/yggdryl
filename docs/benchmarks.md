...
| Expression | [Evaluate](expression/evaluate.md) | `benchmarks/expression.rs` writes each predicate by hand against `arrow-ord` / `arrow-select` as the baseli... |
...
| Holder | [Filesystems](holder/backends/filesystems.md) | Every row lands the same payload twice, through an `fs` handle and natively; host and toolchain are the pub... |
...
| Media | [Iceberg](media/iceberg/index.md) | Release Criterion, Windows 11 Pro 10.0.26200, Ryzen 5 150, rustc 1.96.1; the fastavro and PyIceberg baselin... |
...
| Media | [Arrow IPC](media/ipc.md) | Criterion point estimates from a Windows x86_64 release smoke run on an AMD Ryzen 5 150 with rustc 1.96.1 (... |
...
| Types | [Scalar](types/scalar.md) | Release builds, Windows x86_64, AMD Ryzen 5 150, rustc 1.96.1, CPython 3.12.13, Node 24.18.0 (2026-08-24);... |
