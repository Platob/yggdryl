...
```text
gzip encode (yggdryl)      1.981 ms    520.0 MiB/s
gzip encode (stdlib gzip)  3.014 ms    341.7 MiB/s
gzip decode (yggdryl)      0.528 ms   1950.7 MiB/s
gzip decode (stdlib gzip)  0.496 ms   2077.9 MiB/s
zlib encode (yggdryl)      6.862 ms    150.1 MiB/s
zlib encode (stdlib zlib)  3.085 ms    333.8 MiB/s
zlib decode (yggdryl)      0.541 ms   1902.5 MiB/s
zlib decode (stdlib zlib)  0.597 ms   1726.3 MiB/s
...
The reading either way: the gzip encoder outruns the stdlib's, decodes are parity, the zlib
encoder currently trails it, and the Parquet path sits within ~15% of PyArrow's own writer and
reader on the same rows. A table like this is regenerated by running the benchmark and pasting
