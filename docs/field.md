...
The [ASCII widths](datatype.md#ascii-widths-and-the-registered-codes) are parameterless
...
[The GUID](datatype.md#the-guid) is parameterless in the same way: `GuidField` gets the static
